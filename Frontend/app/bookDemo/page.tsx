...
import DemoBackground from '@/public/images/demo-background.jpg'; // Replace with your background image
...
const BookDemo = () => {
    ...
    const validateForm = () => {
        ...
        if (!/^[\w-.]+@([\w-]+\.)+[\w-]{2,4}$/.test(email)) errors.email = 'Enter a valid email';
        if (!phone) errors.phone = 'Phone number is required';
        if (phone && !/^\d{10}$/.test(phone)) errors.phone = 'Enter a valid phone number';
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if (validateForm()) {
            ...
            setSnackbar({ open: true, message: 'Demo requested successfully!', severity: 'success' });
    ...
    return (
        <div className={styles.bookDemo}>
            <div className="relative bg-purple-600 py-4 px-10 mx-10 md:py-7 md:px-12 rounded-lg" data-aos="fade-up">
                ...
                <div className="relative flex flex-col lg:flex-row justify-between items-center">
                    ...
                    <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
                        <h3 className="h3 text-white mb-2 te">Book A Demo With Us</h3>
                        <p className="text-purple-200 text-lg pt-4">
                            Discover how HoloLearn can revolutionize your educational experience.
                            Please enter your details below and we will get in touch to schedule a personalized demo session.
                        </p>
                        <div className="mt-6">
                            <Image src={DemoBackground}
                                alt="Demo Background"
                                width={500}
                            />
                        </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate autoComplete="off" className={styles.fomr}>
                        <TextField
                            required
                            id="name"
                            label="Full Name"
                        ...
                        <div className='py-6'>
                            <TextField
                                ...
                                InputProps={{
                                    style: { color: '#fff', gap: '0.25rem', paddingTop: '1rem', paddingBottom: '1rem' },
                                }}
                            ...
                            >
                                <option value="xr-integration">Educational XR Technology Integration</option>
                                <option value="content-creation">3D Interactive Content Creation</option>
                                <option value="student-engagement">Student Engagement and Interactive Learning</option>
                                <option value="student-engagement">Other (Please Specify)</option>
                            </TextField>
                        </div>
                        <TextField
                            required
                        ...
                        />
                        <Button variant="contained" color="primary" size="large" className={styles.demoButton} type="submit">
                            Book Now!
                        </Button>
                    </form>
